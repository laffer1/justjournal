...
/**
 * Class _User was generated by Cayenne. It is probably a good idea to avoid changing this class manually, since it may
 * be overwritten next time code is regenerated. If you need to make any customizations, please use subclass.
 */
public abstract class _User extends CayenneDataObject {
    ...
    public void addToUserToUserLink(UserLink obj) {
        addToManyTarget(USER_TO_USER_LINK_PROPERTY, obj, true);
    }

    public void removeFromUserToUserLink(UserLink obj) {
        removeToManyTarget(USER_TO_USER_LINK_PROPERTY, obj, true);
    }

    @SuppressWarnings("unchecked")
    public List<UserLink> getUserToUserLink() {
        return (List<UserLink>) readProperty(USER_TO_USER_LINK_PROPERTY);
    }
