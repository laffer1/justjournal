...
<div id="content">
   ...
   <p>
    This is the complete list of moods that you can choose from when posting a journal entry.
       Parent moods are used to display an emoticon for a mood if the mood does not have its own emoticon.
