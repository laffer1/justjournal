...
<div id="content">
    ...
    <p>This version includes a slightly new theme, Outlook integration is back, and runs on .NET framework 3.5. Tagging
        was also introduced into the client. It works just like the online form with spaces or commas separating tags.
        You
    ...
    <p>The Windows clients require the .NET framework 2.0. You can get it from Microsoft Windows Update (in XP or 2000)
        if you do not
